...
- 在本报告形成时，编码表状态为`CALIBRATION_READY / NOT_FROZEN`，尚未形成正式盲试信度结果；因此当时建议先做作者角色试点。当前执行状态只以编码表v3.13.0与替代决定为准。
...
- [x] 历史处置：该待决项已由编码表v3.12.0—v3.13.0及2026-08-24试编码启动决定替代；本文保持`SUPERSEDED / HISTORICAL`，不得继续作为当前审批项。
