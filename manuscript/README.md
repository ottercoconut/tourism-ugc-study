...
当前Markdown主文稿为[`论文草稿.md`](论文草稿.md)，状态为`NEEDS_UPDATE`：方法定位、V6以及共同校准记录契约已同步，但字段、模型与执行段落尚未完整承接固定文件`docs/data-dictionary/编码表.md` v3.6.0。论文只解释编码表，不得反向覆盖其构念、标签或方法口径。
